<meta charset="UTF-8">
<base href="<?php echo base_url() ?>resource/backend/">
</base>
...
<link rel="stylesheet" type="text/css" href="css/theme_gold.css">
...
<style>
    ...
    /* for nav background-color - Strat */
    .header {
        background-color: #9C5658 !important;
    }
    ...
    .nav_profile .profile-left .media-heading {
        color: #9C5658 !important;
    }

    #menu li.active > a {
        color: #9C5658 !important;
        border-right: 3px solid #9C5658 !important;
    }
