...
Date.prototype.getWeek = function(t) {
        if (t) {
            ...
            var o = e.valueOf();
            return e.setMonth(0, 1), 4 != e.getDay() && e.setMonth(0, 1 + (4 - e.getDay() + 7) % 7), 1 + Math.ceil((o - e) / 6048e5)
        }
        var i = new Date(this.getFullYear(), 0, 1);
        return Math.ceil(((this.getTime() - i.getTime()) / 864e5 + i.getDay() + 1) / 7)
    ...
    function(t) {
        ...
        function o(e, n) {
            ...
            return t.each(l, function(e, a) {
                ...
                if (t.each(e.split(">"), function(t, a) {
                        var d, h = null;
                        if (d = /^(\d\d)-(\d\d)$/.exec(a)) h = new Date(n, parseInt(d[2], 10) - 1, parseInt(d[1], 10));
                        else if (d = /^(\d\d)-(\d\d)-(\d\d\d\d)$/.exec(a)) parseInt(d[3], 10) == n && (h = new Date(n, parseInt(d[2], 10) - 1, parseInt(d[1], 10)));
                        else if (d = /^easter(([+\-])(\d+))?$/.exec(a)) h = r(n, d[1] ? parseInt(d[1], 10) : 0);
                            ...
                            switch (c) {
                                case "+":
                                    for (var f = new Date(n, p, -6); f.getDay() != m;) f = new Date(f.getFullYear(), f.getMonth(), f.getDate() + 1);
                                    h = new Date(f.getFullYear(), f.getMonth(), f.getDate() + 7 * u);
                                    break;
                                case "-":
                                    for (var f = new Date(n, p + 1, 7); f.getDay() != m;) f = new Date(f.getFullYear(), f.getMonth(), f.getDate() - 1);
                                    h = new Date(f.getFullYear(), f.getMonth(), f.getDate() - 7 * u)
                            }
                        }
                        ...
                        switch (t) {
                            case 0:
                                ...
                                break;
                            case 1:
                                if (h.getTime() <= o.getTime()) return i("Unknown holiday: " + e), l = !0, !1;
                                s = h;
                                break;
                            default:
                    ...
                    var d = [];
                    if (s)
                        for (var p = new Date(o.getTime()); p.getTime() <= s.getTime(); p.setDate(p.getDate() + 1)) d.push(new Date(p.getTime()));
                    else d.push(o);
                    h.push({
                        name: a,
                        days: d
        ...
        function s(e, a, o, i) {
            ...
            a.fadeOut("fast"), o.slideUp("fast", function() {
                ...
                o.html(i.options.templates["events-list"]({
                    cal: i,
                    events: i.getEventsBetween(parseInt(e.data("cal-start")), parseInt(e.data("cal-end")))
                })), s.after(o), i.activecell = t("[data-cal-date]", n).text(), t("#cal-slide-tick").addClass("tick" + r).show(), o.slideDown("fast", function() {
        ...
        o.cache = {}, n.prototype.setOptions = function(e) {
            ...
            var e = t.split(":"),
                ...
                o = parseInt(e[1]),
                i = "";
            return this.options.format12 && (i = 12 > a ? this.options.am_suffix : this.options.pm_suffix, a %= 12, 0 == a && (a = 12)), ("" + a).formatNum(2) + ":" + ("" + o).formatNum(2) + i
            ...
            var a = this,
                ...
                n = 60 / o,
                s = Math.min(n, 1);
            (n >= 1 && 0 != n % 1 || 1 > n && 0 != 1440 / o % 1) && t.error(this.locale.error_timedevide);
            ...
            c.setHours(l[0]), c.setMinutes(l[1]), e.all_day = [], e.by_hour = [], e.after_time = [], e.before_time = [], t.each(e.events, function(t, o) {
                ...
                if (o.start_hour = a._format_time(n), o.end_hour = a._format_time(s), o.start < p.getTime() && (i(1), o.start_hour = n.getDate() + " " + a.locale["ms" + n.getMonth()] + " " + o.start_hour), o.end > c.getTime() && (i(1), o.end_hour = s.getDate() + " " + a.locale["ms" + s.getMonth()] + " " + o.end_hour), o.start < p.getTime() && o.end > c.getTime()) return e.all_day.push(o), void 0;
            ...
            var e = {},
                ...
                s = this,
                r = a(this, "first_day");
            return t.each(this.getEventsBetween(o, i), function(t, e) {
                e.start_day = new Date(parseInt(e.start)).getDay(), 1 == r && (e.start_day = (e.start_day + 6) % 7), e.days = 864e5 >= e.end - e.start ? 1 : (e.end - e.start) / 864e5, o > e.start && (e.days = e.days - (o - e.start) / 864e5, e.start_day = 0), e.days = Math.ceil(e.days), e.start_day + e.days > 7 && (e.days = 7 - e.start_day), n.push(e)
            }), e.events = n, e.cal = this, s.options.templates["week-days"](e)
            ...
            if (o + 1 > l && (this.stop_cycling = !0), o > l && (o -= l, n = this.options.classes.months.outmonth), n = t.trim(n + " " + this._getDayClass("months", r)), 0 >= o) {
            ...
            return h !== !1 && (i.tooltip = h), i.data_day = r.getFullYear() + "-" + r.getMonthFormatted() + "-" + (10 > o ? "0" + o : o), i.cls = n, i.day = o, i.start = parseInt(r.getTime()), i.end = parseInt(i.start + 864e5), i.events = this.getEventsBetween(i.start, i.end), this.options.templates["month-day"](i)
            ...
            var a = this,
                o = function(e, o) {
                    var i;
                    i = a.options.classes && t in a.options.classes && e in a.options.classes[t] ? a.options.classes[t][e] : "", "string" == typeof i && i.length && o.push(i)
                },
                i = [];
            ...
            if ("now" == this.options.day) {
                ...
                e = parseInt(s[0], 10), o = parseInt(s[1], 10) - 1, i = parseInt(s[2], 10)
            ...
            switch (this.options.view) {
                ...
                case "month":
                    ...
                    break;
                case "day":
                    this.options.position.start.setTime(new Date(e, o, i).getTime()), this.options.position.end.setTime(new Date(e, o, i + 1).getTime());
                    break;
                case "week":
                    var r, l = new Date(e, o, i);
            ...
            switch (this.options.view) {
                ...
                case "week":
                    return this.locale.title_week.format(t.getWeek(a(this, "week_numbers_iso_8601")), t.getFullYear());
                case "day":
            ...
            var a = this,
                o = null;
            "events_source" in this.options && "" !== this.options.events_source ? o = this.options.events_source : "events_url" in this.options && (o = this.options.events_url, i("The events_url option is DEPRECATED and it will be REMOVED in near future. Please use events_source instead."));
            var n;
            switch (t.type(o)) {
                case "function":
                    n = function() {
                ...
                case "string":
                    o.length && (n = function() {
                        ...
                        return p.length && (r.browser_timezone = p), t.ajax({
                            url: e(o, r),
                            dataType: "json",
                            type: "GET",
                            async: !1
            ...
            n || t.error(this.locale.error_loadurl), this.options.onBeforeEventsLoad.call(this, function() {
                a.options.events.length && a.options.events_cache || (a.options.events = n(), a.options.events.sort(function(t, e) {
                    var a;
            ...
            if (t("a[data-event-id]", this.context).unbind("click"), e.options.modal) {
                ...
                if (a.length) {
                    ...
                    "iframe" == e.options.modal_type && (o = t(document.createElement("iframe")).attr({
                        ...
                        "iframe" == e.options.modal_type && (o.attr("src", n), t(".modal-body", a).html(o)), (!a.data("handled.bootstrap-calendar") || a.data("handled.bootstrap-calendar") && a.data("handled.event-id") != i.id) && a.off("show.bs.modal").off("shown.bs.modal").off("hidden.bs.modal").on("show.bs.modal", function() {
                            ...
                            switch (e.options.modal_type) {
                                ...
                                case "ajax":
                                    ...
                                    break;
                                case "template":
                                    e._loadTemplate("modal"), o.html(e.options.templates.modal({
                                        event: i,
                                        calendar: e
                                    }))
                            }
                            _.isFunction(e.options.modal_title) && a.find(".modal-title").html(e.options.modal_title(i))
                        }).on("shown.bs.modal", function() {
                            e.options.onAfterModalShown.call(e, e.options.events)
                        }).on("hidden.bs.modal", function() {
                            e.options.onAfterModalHidden.call(e, e.options.events)
                        }).data("handled.bootstrap-calendar", !0).data("handled.event-id", i.id), a.modal("show")
                    })
                }
            }
        }, n.prototype._update_day = function() {
            t("#cal-day-panel").height(t("#cal-day-panel-hour").height())
        }, n.prototype._update_week = function() {}, n.prototype._update_year = function() {
            ...
            if (1 == this.options.weekbox) {
                var o = t(document.createElement("div")).attr("id", "cal-week-box"),
                    i = this.options.position.start.getFullYear() + "-" + this.options.position.start.getMonthFormatted() + "-";
                e.context.find(".cal-month-box .cal-row-fluid").on("mouseenter", function() {
                    var n = new Date(e.options.position.start),
                        s = t(".cal-cell1:first-child .cal-month-day", this),
                        r = s.hasClass("cal-month-first-row") ? 1 : t("[data-cal-date]", s).text();
                    n.setDate(parseInt(r)), r = 10 > r ? "0" + r : r, o.html(e.locale.week.format(1 == e.options.display_week_numbers ? n.getWeek(a(e, "week_numbers_iso_8601")) : "")), o.attr("data-cal-week", i + r).show().appendTo(s)
            ...
            if (this.options.views[this.options.view].slide_events) {
                var e = this,
                    a = t(document.createElement("div")).attr("id", "cal-day-tick").html('<i class="icon-chevron-down glyphicon glyphicon-chevron-down"></i>');
                e.context.find(".cal-month-day, .cal-year-box .span3").on("mouseenter", function() {
                    0 != t(".events-list", this).length && t(this).children("[data-cal-date]").text() != e.activecell && a.show().appendTo(this)
                }).on("mouseleave", function() {
                    a.hide()
                }).on("click", function(i) {
                    0 != t(".events-list", this).length && t(this).children("[data-cal-date]").text() != e.activecell && s(i, a, o, e)
                });
