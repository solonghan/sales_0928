...
var render$1 = {
  ...
  initContainer: function initContainer() {
    ...
    var h = Math.max(container.offsetHeight, Number(options.minContainerHeight) || 100);
    var c_h = Math.min(h, $(window).height()-250);

    var w = Math.max(container.offsetWidth, Number(options.minContainerWidth) || 200);
    var c_w = w * (c_h/h);
