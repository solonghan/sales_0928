...
require_once(APPPATH . 'libraries/upgrad/Part_1_plan.php');

require_once(APPPATH . 'libraries/upgrad/Part_12_plan.php');



class Full_upgrad_store extends Upgrad_store {
...

	{
...

		{
			...
			case 'part_1':
				...
				return new Part_1_plan($priv_end_date);

			case 'part_12':

				return new Part_12_plan($priv_end_date);
