            ...
            <!-- <div class="row">
                <div class="main-widgets">
                    <div class="col-md-12 col-sm-12 text-center">
                        <h4>近<?=$pre_days ?>日數據統計</h4>
                    </div>
                    <? foreach ($chart as $project_id => $obj): ?>
                    <div class="col-md-4 col-sm-4 text-center">
                        <div class="sales-data">
                            <h4><b><?=$obj['title'] ?></b></h4>
                            <div class="row">
                                <div class="col-xs-4 daily-data">累計金額 <br> <b><?=$obj['total_amount'] ?></b></div>
                                <div class="col-xs-4 monthly-data">訂單數 <br> <b><?=$obj['bill_cnt'] ?></b></div>
                                <div class="col-xs-4 actual">祈福人數 <br> <b><?=$obj['wish_cnt'] ?></b></div>
                                <div class="col-xs-12">
                                    <hr>
                                </div>
                                <div class="col-xs-12">
                                    <span id="sales-<?=$project_id ?>-chart"></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    // 等有空再研究
    // <?php foreach ($chart as $project_id => $obj): ?>
    //     $("#sales-<?=$project_id ?>-chart").sparkline(<?php echo json_encode($obj['chart']); ?>, {
    //         type: 'line',
    //         width: '100%',
    //         height: '55',
    //         lineColor: '#FFE5C0',
