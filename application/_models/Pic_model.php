...
class Pic_model extends CI_Model {
    ...
    /* crop */
    public function crop_img_upload($dir = FALSE, $name = "imageData")
    {
    ...
    public function crop_img_upload_front($dir = FALSE, $name = "imageData", $user)
    {
        ...
        $meeting = $this->db->select("*")->from("meeting")->where("event_uid = '$event_uid'")
        ->get()->row_array();

        $dir_path = $this->upload_path . $user['type'] . '/' . $meeting['year'] . '/' . $meeting['show_id'] . '/';
        ...
        // $filepath = $this->upload_path.time().uniqid().".jpg";
        $filepath =
            $this->upload_path . $user['type'] . '/' . $meeting['year'] . '/' . $meeting['show_id'] . '/' . $user['user_id'] . ".jpg";
