...
<head>
    <meta charset="UTF-8">
    <base href="<?= base_url() ?>resource/backend/">
    </base>
    <title>後台管理系統</title>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 login-form">
                <div class="panel-header text-center">
                    <h2 class="text-center"><img src="<?= base_url() ?>resource/backend/logo.svg" alt="Logo" width="100"></h2>
                        ...
                        <div class="col-xs-12">
                            ...
                            <form action="<?= base_url() ?>mgr/Login" id="authentication" method="post" class="login_validator">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control form-control-lg" id="password" name="password" placeholder="密碼">
                                </div>
