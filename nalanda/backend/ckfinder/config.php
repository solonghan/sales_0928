<?php
	...
	// $credentials = $_SESSION["ckfinderUnlock"];
	// if(@$_SESSION[$credentials]!=true) exit();
	
	$first_word = mb_substr($_SERVER['SERVER_NAME'],0,3,'utf-8');
	if($_SERVER['SERVER_NAME'] == "localhost" || $first_word == "192") $dir_name = "/microtek/uploads/";
	else $dir_name = "/uploads/";
/*
